    ...
    render() {
      ...
      const donateText = (
        <div>
          ...
          <p>
            We rely soely on donations, in both time and money to keep this dream alive!
          </p>
          <p>
            By donating below, you can help us continue to run classes, set up job opportunties and XXXX.
            We accept bitcoin.
          </p>
